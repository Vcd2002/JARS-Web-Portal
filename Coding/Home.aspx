...
<body>
    ...
    <div id="header">
        ...
        <asp:Image ID="Image3" runat="server" ImageUrl="~/img/logo1.jpg" />
    ...
    <div id="menu">
        <table class="style1">
            <tr>
                ...
                <td class="style2">
                    <asp:Button ID="Button4" runat="server" CssClass="btnmenu" Text="Branch&Year" 
...
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
	...
	<script type="text/javascript" src="engine1/script.js"></script>
     ...
     </div> <div id="footer">©2023 JARS WebPortal. All Rights Reserved.</div>
    </form>
</body>
</html>
